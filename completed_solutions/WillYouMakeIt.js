...
// possible to get to the pump or not. Function should return true (1 in Prolog) 
// if it is possible and false (0 in Prolog) if not. The input values are always
//  positive.

const zeroFuel =  (distanceToPum, mpg, fuelLeft) => {

  
    if (distanceToPum <= mpg * fuelLeft){
      return 1;
      }
      else    
        return 0;
